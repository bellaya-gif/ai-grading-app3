...
st.title("📝 문장 성분 및 문장 구조 서술형 평가 시스템")
st.caption(
...
with tab1:
    ...
    st.info(
        """
    **[문제]** 다음 문장을 바탕으로 서술어 '선물했다'의 자릿수를 제시하고, 이 문장에서 부사어의 형태를 띠면서도 생략하기 어려운 문장 성분을 찾아 그 이유를 서술하시오.
...
with tab2:
    ...
    st.info(
        """
    **[문제]** 다음 (가), (나)의 밑줄 친 문장 성분의 명칭을 각각 쓰고, 두 성분을 구별하는 문법적 기준을 서술하시오.
    
    * (가) 기범이는 훌륭한 <u>교사가</u> 되었다.
    * (나) 얼음이 <u>물로</u> 되었다.
    """
    )
